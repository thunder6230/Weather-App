...
function getNewWeather(){
    const inputCity = document.querySelector('#city')
    console.log(inputCity)
    if(inputCity.textContent === ''){
        setTimeout(function(){inputCity.textContent = `Please add a location!`}, 3000)
    ...
    .then((data) => {
        ...
        switch(lang){
            ...
            case 'hu':
                ...
                wind.innerHTML = ` Szel Sebesseg: ${Math.floor(obj[5].speed * 3.6)} km/h` 
                break
            case 'de':
                ...
                wind.innerHTML = `Wind Geschwindigkeit: ${Math.floor(obj[5].speed * 3.6)} km/h`  
                break  
        }
    })
    }  
